...
class url:
    ...
    clang_prebuilt_binary_for_macos_arm64 = 'https://github.com/charmingQin/llvm-builder/releases/download/llvm-15.0.0/clang+llvm-15.0.0-arm64-apple-darwin21.0.tar.xz'
    ...
    clang_prebuilt_binary_for_ubuntu_lts_20_aarch64 = 'https://github.com/llvm/llvm-project/releases/download/llvmorg-15.0.0/clang+llvm-15.0.0-aarch64-linux-gnu.tar.xz'
